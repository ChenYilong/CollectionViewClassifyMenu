...
- (void)awakeFromNib
{
    ...
    [_titleLabel addSubLayerWithFrame:CGRectMake(0, _titleLabel.frame.size.height - 0.5f, _titleLabel.frame.size.width, 0.5f) color:[UIColor colorWithRed:146/255.f green:175/255.f blue:164/255.f alpha:1.f].CGColor];
